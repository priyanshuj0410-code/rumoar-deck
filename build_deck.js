...
.slide{width:1280px;height:720px;position:absolute;inset:0;background:var(--paper);color:var(--ink);overflow:hidden;display:none}
...
.tile{background:var(--wash);border-radius:0;padding:20px}
.dark .tile{background:var(--carbon)}
...
.col{background:var(--wash);border-radius:0;padding:20px}
...
.tbl td{padding:9px 11px;border-bottom:1px solid var(--line);vertical-align:top;color:var(--graphite);line-height:1.35}
.tbl td.b{color:var(--ink);font-weight:600}
.tbl tbody tr:last-child td{border-bottom:0}
/* takeaway */
.take{background:var(--ink);color:var(--porcelain);border-radius:0;padding:15px 20px;font-size:13px;line-height:1.42;font-weight:500;border-left:4px solid var(--peri)}
...
.fr{background:var(--ink);color:#fff;border-radius:0;padding:9px 14px;display:flex;justify-content:space-between;align-items:center;margin-bottom:2px}
...
.sambar{background:var(--dusk);color:#fff;border-radius:0;padding:12px 14px;font-family:var(--display);font-weight:600;font-size:16px;margin-top:6px}
.sidebox{background:var(--wash);border-radius:0;padding:22px;display:flex;flex-direction:column;justify-content:center}
...
.mr{background:var(--wash);border-radius:0;padding:11px 16px;display:grid;grid-template-columns:230px 1fr;gap:14px;align-items:start}
...
.cg{background:var(--carbon);border-radius:0;padding:16px}
...
/* T02/T03 components */
.posbox{background:var(--ink);color:var(--porcelain);border-radius:0;padding:22px 26px;font-family:var(--display);font-weight:500;font-size:19px;line-height:1.32;letter-spacing:-.01em;margin-bottom:16px}
.gates{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:16px}
.gate{background:var(--wash);border-radius:0;padding:20px}
...
.sw2{flex:1;border-radius:0;padding:12px 12px 14px;min-height:74px;display:flex;flex-direction:column;justify-content:flex-end}
...
.mc{background:var(--wash);border-radius:0;padding:13px 17px}
...
(function(){
  ...
  function fit(){ var st=document.getElementById('stage'); var w=(st?st.clientWidth:window.innerWidth), h=(st?st.clientHeight:window.innerHeight); var docked=document.body.classList.contains('docked'); var s=Math.min(w/1280, h/720); if(docked) s*=0.94; scaler.style.transform='scale('+s+')'; document.documentElement.style.setProperty('--deckh', Math.round(720*s)+'px'); scaler.style.borderRadius = docked ? (Math.round(480/s)/10)+'px' : '0px'; }
